...
public abstract class FilterableAdapter extends BaseAdapter implements
		Filterable {
	/**
	...
	private String hashMapKeyForFiltering;
		...
		protected FilterResults performFiltering(CharSequence prefix) {
			...
			if (prefix == null || prefix.length() == 0) {
				...
				for (int i = 0; i < count; i++) {
					...
					final String valueText = value.get(hashMapKeyForFiltering).toLowerCase();
